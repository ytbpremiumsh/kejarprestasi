  ...
  return <footer className="mt-20 border-t border-border bg-foreground text-background">
    <div className="container-page py-12 md:py-16">
      <div className="grid gap-10 border-b border-background/15 pb-12 lg:grid-cols-[1.2fr_.8fr_.8fr]">
        <div className="max-w-xl"><img src={footerLogo} alt="Kejar Prestasi" className="h-10 w-auto max-w-[190px] brightness-0 invert" loading="lazy" /><h2 className="mt-7 text-2xl font-extrabold leading-tight md:text-3xl">Kesempatan pendidikan dimulai dari satu langkah.</h2><p className="mt-3 max-w-lg text-sm leading-6 text-background/60">Kejar Prestasi membuka akses program beasiswa bagi pelajar dan mahasiswa Indonesia melalui jalur Prestasi dan Ekonomi.</p><div className="mt-6 flex flex-wrap gap-3"><Link to="/daftar" className="inline-flex items-center gap-2 rounded-full bg-background px-5 py-3 text-sm font-bold text-foreground">Lihat Program <ArrowUpRight size={16} /></Link><Link to="/cek-status" className="rounded-full border border-background/20 px-5 py-3 text-sm font-semibold text-background">Cek Status</Link></div></div>
