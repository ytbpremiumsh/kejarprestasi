...
function RegistrationPathModal({registerTo,kind,onClose}:{registerTo:RegistrationPath;kind:CategoryKind;onClose:()=>void}){
  ...
  const paths=[
    ...
    {id:"akselerasi" as PathId,name:"Akselerasi",price:"Rp15.000",icon:Zap,theme:"accent" as const,badge:"REKOMENDASI",desc:"Proses lebih cepat",highlight:"Lolos administrasi otomatis",features:["Peluang dana pendidikan hingga Rp23 juta / semester","Proses dipercepat",...digitalBenefits]},
    {id:"platinum" as PathId,name:"Platinum",price:"Rp45.000",icon:Crown,theme:"premium" as const,badge:"PREMIUM",desc:"Benefit eksklusif",highlight:"Lolos administrasi otomatis",features:["Peluang dana hingga Rp23 juta / semester + Tablet Awardee","Prioritas proses",...digitalBenefits]},
  ];
