...
function RegistrationPathModal({ registerTo, kind, onClose }: { registerTo: RegistrationPath; kind: CategoryKind; onClose: () => void }) {
  ...
  const paths: Array<{ id: PathId; name: string; price: string; description: string; icon: typeof Clock3; theme: "regular" | "accent" | "premium"; badge?: string; features: string[]; highlight?: string }> = [
    { id: "reguler", name: "Jalur Reguler", price: "Gratis", icon: Clock3, theme: "regular", description: "Jalur pendaftaran standar tanpa biaya. Peserta mengikuti seluruh tahapan program sesuai ketentuan.", features: ["Wajib membagikan Twibbon Program", "Wajib membagikan Poster Program", "Wajib Follow Instagram Resmi Program Beasiswa", "E-Book Panduan Meraih Beasiswa", "E-Sheet Rencana Belajar & Target"] },
    ...
    { id: "platinum", name: "Jalur Akselerasi Platinum", price: "Rp45.000", icon: Tablet, theme: "premium", badge: "PREMIUM", description: "Pilihan premium dengan kemudahan Akselerasi dan tambahan kesempatan dukungan perangkat belajar.", highlight: "Lolos administrasi secara otomatis", features: ["Berkesempatan meraih dana pendidikan beasiswa", "Proses pendaftaran diprioritaskan", "Sertifikat peserta program", "E-Book Masterplan Pendidikan & Prestasi", "E-Sheet Dashboard Target Belajar", "Berkesempatan mendapatkan Tablet Pendidikan untuk mendukung kebutuhan belajar"] },
  ];
