...
function RegistrationPathModal({registerTo,kind,onClose}:{registerTo:RegistrationPath;kind:CategoryKind;onClose:()=>void}){
  ...
  const paths=[
    ...
    {id:"platinum" as PathId,name:"Platinum",price:"Rp45.000",icon:Crown,theme:"premium" as const,badge:"KUOTA TERBATAS",desc:"Benefit eksklusif",highlights:["Lolos Studi Kasus","Lolos Administrasi Program","Ikut Tes Potensi Akademik"],features:["Peluang dana hingga Rp23 juta / semester + Tablet Awardee","Prioritas proses",...digitalBenefits]},
  ];
