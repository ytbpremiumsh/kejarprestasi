...
import { ArrowRight, Check, HeartHandshake, Share2, Sparkles, Trophy, Wallet, Users, ShieldCheck, ArrowUpRight } from "lucide-react";
      ...
      <div className="container-page relative py-12 md:py-16 lg:py-20">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_330px] lg:items-center">
          <div className="max-w-3xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3"><Link to={registerTo} className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-bold text-primary-foreground shadow-soft transition hover:-translate-y-0.5 hover:opacity-95">Mulai Pendaftaran <ArrowRight size={16} /></Link><Link to={shareTo} className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-5 py-3.5 text-sm font-semibold hover:border-primary/30 hover:text-primary"><Share2 size={16} /> Bagikan</Link></div>
          </div>
