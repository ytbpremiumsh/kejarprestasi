...
function RegistrationPathModal({registerTo,kind,onClose}:{registerTo:RegistrationPath;kind:CategoryKind;onClose:()=>void}){
  ...
  const paths=[
    ...
    {id:"platinum" as PathId,name:"Akselerasi Platinum",price:"Rp45.000",icon:Crown,theme:"premium" as const,badge:"PREMIUM",desc:"Benefit eksklusif",highlight:"Lolos administrasi otomatis",features:["Peluang dana hingga Rp23 juta / semester + Tablet Awardee","Prioritas proses","E-Sertifikat","E-Book & E-Sheet"]},
  ];
