  ...
  return (
    <section className="border-y border-border bg-secondary/30">
      <div className="container-page py-16 md:py-20">
        ...
        <div className="mx-auto mt-10 grid max-w-6xl gap-8 lg:grid-cols-[0.86fr_1.4fr] lg:items-start lg:gap-10">
